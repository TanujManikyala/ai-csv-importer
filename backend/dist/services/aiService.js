...
exports.mapBatchToCRM = mapBatchToCRM;
...
`;
async function mapWithGemini(records, apiKey) {
...
async function mapWithOpenAI(records, apiKey) {
...
async function mapBatchToCRM(records) {
